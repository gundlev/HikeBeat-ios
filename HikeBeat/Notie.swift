...
//    public var messageBackgroundColor = UIColor(red: 39.0 / 255.0, green: 174.0 / 255.0, blue: 96.0 / 255.0, alpha: 1.0)
...
// The progressView itteration is one i have made myself.
        } else if self.style == .Progress {
            //self.addInputFieldPadding()
...
// This is my own private function!!
    private func configureProgressView() {
        self.contentView.addArrangedSubview(self.progressView)
        progressView.widthAnchor.constraintEqualToAnchor(self.contentView.widthAnchor).active = true
    }
