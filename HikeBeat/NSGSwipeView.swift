...
//                    if recognizer.locationOfTouch(0, inView: self).x >= initialCenterDragView.x && recognizer.locationOfTouch(0, inView: self).x <= (self.frame.width - initialCenterDragView.x) {
//
//                        if translation.x + localView.center.x <= (self.frame.width - initialCenterDragView.x) {
//
//                            localView.center = CGPoint(x:localView.center.x + translation.x,
//                                y:localView.center.y)
//                            self.shadowView.frame.size.width = (shadowView.frame.size.width + translation.x)
...
//                            self.shadowView.center = CGPoint(x: self.shadowView.center.x, y: self.shadowView.center.y)
//
//                        } else if translation.x + localView.center.x > (self.frame.width - initialCenterDragView.x) {
//                            localView.center.x = self.frame.width - initialCenterDragView.x
//                        }
//                    } else if recognizer.locationOfTouch(0, inView: self).x > self.frame.width - initialCenterDragView.x {
//                        localView.center.x = self.frame.width - initialCenterDragView.x
//                        self.shadowView.frame.size.width = self.fullShadowLength
//                        self.shadowView.center = self.fullShadowCenterPoint
//                    } else if recognizer.locationOfTouch(0, inView: self).x < initialCenterDragView.x {
//                        localView.center.x = initialCenterDragView.x
//                    }


//
//                if localView.center.x + translation.x == self.frame.width - initialCenterDragView.x || recognizer.locationInView(self).x >= self.frame.width - initialCenterDragView.x{
//                    localView.center.x = (self.frame.width - initialCenterDragView.x)
//
//                    print("OH YEAH! Action send!!")
//                    self.action()
//                    let num = self.center.x + translation.x
//                    print(num)
//                    print(self.frame.width - initialCenterDragView.x)
//                } else {
//                    let duration = NSTimeInterval(0.1)
//                    UIView.animateWithDuration(duration, animations: {
//                        recognizer.view?.center = self.initialCenterDragView
//                        self.shadowView.frame.size.width = self.shadowView.frame.size.height
//                        self.shadowView.center = self.initialCenterDragView
//                    })
//
...
//                    //                    })
//                    //localView.center = initialCenter
//
//                }
